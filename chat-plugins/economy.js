...
exports.commands = {
	...
	startdice: function (target, room, user) {
		...
		room.addRaw('<div class="infobox"><h2><center><font color="' + color(user.userid) + '">' + user.name + '</font> <font color=#24678d>has started a dice game for </font><font color="red">' + target + 
